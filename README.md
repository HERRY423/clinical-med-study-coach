...
如果你知道原始经验贴的作者，建议在下方"致谢"里署名并附链接，尊重原作者的分享。
...
见 [LICENSE](./LICENSE)。本仓库以文字内容为主，若你更看重"署名 + 同样方式共享"，也可考虑改用 Creative Commons（如 CC BY-SA 4.0）。

## 致谢

- 学习方法核心来自一位临床医学生的公开经验分享（如知原作者，请在此署名并附原文链接）。
- 由 Claude 整理为 Agent Skill 结构并补充缺失环节。
